...
<body>
    <div class="container">
        <h2>Welcome, <?= htmlspecialchars($user['fullname'] ?? ($_SESSION['email'] ?? 'User')); ?>!</h2>
        <p>Let's set up your future!</p>
        <p><a href="#" onclick="confirmLogout(); return false;" class="btn-logout">Logout</a></p>
    </div>
